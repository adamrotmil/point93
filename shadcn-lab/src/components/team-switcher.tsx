...
export function TeamSwitcher({ plan }: { plan: string }) {
  ...
  return (
    <SidebarMenu>
      <SidebarMenuItem>
        {collapsed ? (
          <div className="flex size-9 items-center justify-center rounded-xl bg-sidebar-accent text-[11px] font-semibold tracking-[0.14em] text-sidebar-foreground">
            P93
          </div>
        ) : (
          <div className="px-1 py-1">
            <img
              src="/p93-logo-spread.png"
              alt="Point93"
